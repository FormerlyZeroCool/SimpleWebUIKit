...
export class ListenerTypes {
    ...
    constructor()
    {
        ...
        this.longpress = new Array<TouchHandler>();
    }
};
...
export class SingleTouchListener
{
    ...
    touchStartHandler(event:any):void
    {
        ...
        this.moveCount = 0;
        event.timeSinceLastTouch = this.timeSinceLastTouch;
        this.startTouchTime = Date.now();
        ...
        if(this.registeredTouch)
        {
            ...
            if(touchEnd)
            {
                ...
                try 
                {
                    ...
                    else if(event.moveCount < 30)
                    {
                        this.callHandler("longpress", event);
