...
import { FixedSizeQueue, RollingStack, logToServer, max_32_bit_signed } from './utils.js';
...
export class RollingVerticalLayout extends VerticalLayoutManager { 
    stack:FixedSizeQueue<GuiElement>;
    constructor(pixelDim:number[], queue_size:number, x:number = 0, y:number = 0)
    {
        super(pixelDim, x, y);
        this.stack = new FixedSizeQueue<GuiElement>(queue_size);
        this.elements = this.stack.data;
    }
    addElement(element: GuiElement, position?: number): boolean {
